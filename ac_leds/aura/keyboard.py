"""
Module to keep required key code tables.
"""
...
class ROGFunctionKeys(IntEnum):
    """
    Enum of all ROG Function keys.
    """
...
ROG_NPAD_GEARS = [
    [0x0053, 0x004F, 0x0050, 0x004B, 0x004C, 0x004D, 0x0047, 0x0049, 0x0045, 0x00B5, 0x0037], # Reverse
    [0x004F, 0x0051, 0x009C, 0x004B, 0x004C, 0x004E, 0x0047, 0x0045, 0x004A], # Neutral
    [0x0052, 0x0053, 0x0050, 0x004C, 0x0047, 0x0048, 0x00B5], # 1
    [0x0052, 0x0053, 0x004F, 0x004B, 0x004C, 0x004D, 0x0049, 0x0045, 0x00B5, 0x0037], # 2
    [0x0052, 0x0053, 0x0051, 0x004B, 0x004C, 0x004D, 0x0049, 0x0045, 0x00B5, 0x0037], # 3
    [0x0053, 0x0051, 0x004B, 0x004C, 0x004D, 0x0047, 0x0049, 0x0045, 0x0037], # 4
    [0x0052, 0x0053, 0x0051, 0x004B, 0x004C, 0x004D, 0x0047, 0x0045, 0x00B5, 0x0037], # 5
    [0x0052, 0x0053, 0x004F, 0x0051, 0x004B, 0x004C, 0x004D, 0x0047, 0x0045, 0x00B5, 0x0037], # 6
    [0x0053, 0x0051, 0x004C, 0x004D, 0x0049, 0x0045, 0x00B5, 0x0037], # 7
    [0x0052, 0x0053, 0x004F, 0x0051, 0x004B, 0x004C, 0x004D, 0x0047, 0x0049, 0x0045, 0x00B5, 0x0037] # 8
]

class ROGNumpadGearsKeys(IntEnum):
    """
    Enum of all ROG Function keys.
    """
